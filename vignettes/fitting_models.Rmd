...
To get the evolutionary parameters, run `get_evolutionary_parameters()` on the cevodata or models object.
...
```{r}
keep_samples <- get_metadata(cd)$sample_id[1:2]
cd <- cd |> 
...
```{r}
get_model_coefficients(cd, "bs_model")
```
