...
Cumulative tails shows the number of mutations with frequency higher than f (x-axis). It uses the log-log scale by default, in which the power-law tail with $\alpha$ equal to 2 is a straight line.
...
And the model components can be shown or hidded with `show_` arguments
